...
- Added `docs/AI-NOTES.md` documenting AI assistant mistakes during the build (Spring Boot bean lifecycle issue, threshold/design oversimplification, and Slack setup friction); root `README.md` now points to that note.
- Added `docs/DESIGN-DOC.md` covering project motivation, solution approach, tech stack, product tradeoffs, and future enhancements; root `README.md` and `docs/README.md` now link to it.
